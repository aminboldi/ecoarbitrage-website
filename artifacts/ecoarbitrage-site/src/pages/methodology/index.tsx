    ...
    <div className="w-full">
      ...
      <section className="bg-[#F8F5ED] py-24 md:py-32 px-6">
        <motion.div 
          ...
          variants={fadeUp}
        >
          <span className="inline-block text-sm font-semibold tracking-widest uppercase text-[#547808] mb-6">
            Evidence principles
          </span>
          <h1 className="font-serif text-5xl md:text-7xl text-[#152025] leading-[1.1] mb-10 tracking-tight">
      ...
      <section className="bg-white py-24 px-6 border-t border-[#E8E2D2]">
        ...
        >
          <div className="p-8 md:p-12 bg-[#F8F5ED] rounded-[16px] border border-[#E8E2D2]">
            <h2 className="text-[#152025] text-2xl font-medium mb-12 text-center">How evidence flows through the workflow</h2>
            ...
            <div className="flex flex-col gap-4 max-w-2xl mx-auto">
              {[
                ...
                <div key={i} className="flex flex-col sm:flex-row items-center sm:items-start gap-4 p-4 bg-white rounded-[8px] border border-[#E8E2D2] shadow-sm relative z-10">
                  <div className="font-serif text-[#547808] font-medium min-w-[200px] text-lg text-center sm:text-left">
                    {step.layer}
                  </div>
      ...
      <section className="bg-[#F8F5ED] py-24 px-6">
        <motion.div 
          ...
          variants={fadeUp}
        >
          <h2 className="font-serif text-4xl text-[#152025] mb-12 tracking-tight">Inputs</h2>
      ...
      <section className="bg-white py-24 px-6">
        <motion.div 
          ...
          variants={fadeUp}
        >
          <h2 className="font-serif text-4xl text-[#152025] mb-12 tracking-tight">Measurement principles</h2>
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-xl font-medium text-[#152025] mb-3">Observable ≠ proven</h3>
            ...
            <div>
              <h3 className="text-xl font-medium text-[#152025] mb-3">External signals corroborate, not verify</h3>
            ...
            <div>
              <h3 className="text-xl font-medium text-[#152025] mb-3">Uncertainty is a valid output</h3>
            ...
            <div>
              <h3 className="text-xl font-medium text-[#152025] mb-3">Human judgment closes the loop</h3>
      ...
      <section className="bg-[#F1ECE0] py-24 px-6">
        ...
        >
          <div>
            <h2 className="font-serif text-3xl text-[#152025] mb-8">Trust model</h2>
          ...
          <div>
            <h2 className="font-serif text-3xl text-[#152025] mb-8">What this methodology cannot do</h2>
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-center gap-3">
                  <div className="w-1.5 h-1.5 bg-[#A9F00F] rounded-full"></div>
      ...
      {/* Ethical boundaries */}
      <section className="bg-[#152025] text-[#F8F5ED] py-24 px-6">
        <motion.div 
          className="max-w-5xl mx-auto"
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="bg-[#111A23] p-8 rounded-[12px] border border-[#547808]">
