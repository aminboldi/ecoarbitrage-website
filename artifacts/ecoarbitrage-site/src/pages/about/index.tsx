    ...
    <div className="w-full">
      ...
      <section className="bg-[#F8F5ED] py-24 md:py-32 px-6">
        ...
        >
          ...
          <h1 className="font-serif text-5xl md:text-7xl text-[#152025] leading-[1.1] mb-12 tracking-tight">
          ...
          <div className="grid md:grid-cols-2 gap-12 text-[#19211E] text-lg leading-relaxed">
            ...
            <div>
              <h2 className="font-serif text-2xl mb-4 text-[#547808]">Vision</h2>
              <p>
      ...
      <section className="bg-white py-24 md:py-32 px-6">
        <motion.div 
          ...
          variants={fadeUp}
        >
          <h2 className="font-serif text-4xl md:text-5xl text-[#152025] mb-16 tracking-tight">How we work</h2>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {[
              ...
              <div key={i} className="flex gap-6 items-start">
                ...
                <div>
                  <h3 className="text-[#152025] font-medium text-xl mb-2">{principle.title}</h3>
      ...
      <section className="bg-[#F8F5ED] py-24 md:py-32 px-6">
        <motion.div 
          ...
          variants={fadeUp}
        >
          <h2 className="font-serif text-4xl md:text-5xl text-[#152025] mb-6 tracking-tight">The founding team</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white rounded-[12px] p-8 border border-[#E8E2D2] flex flex-col items-center text-center">
                <div className="w-20 h-20 rounded-full bg-[#547808] flex items-center justify-center text-white text-xl font-medium mb-6">
                  {member.role.split(' ')[0][0]}
                </div>
                <h3 className="text-[#152025] font-medium text-lg mb-2">{member.role}</h3>
      ...
      {/* CTA Section */}
      <section className="bg-[#152025] py-24 md:py-32 px-6 text-center">
        <motion.div 
