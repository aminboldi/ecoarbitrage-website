...
export default function Solution() {
  ...
  return (
    <div className="w-full">
      {/* Hero */}
      <section className="bg-[#152025] text-[#F8F5ED] py-24 md:py-32 px-6">
        <motion.div 
        ...
        >
          ...
          <p className="text-sm text-[#A9F00F] mb-10 font-medium tracking-wide">
      ...
      <section className="bg-white py-24 px-6">
        <motion.div 
          ...
          variants={fadeUp}
        >
          <h2 className="font-serif text-4xl md:text-5xl text-[#152025] mb-8 tracking-tight">
      ...
      <section className="bg-[#F8F5ED] py-24 px-6 border-y border-[#E8E2D2]">
        <motion.div 
          ...
          variants={fadeUp}
        >
          <h2 className="font-serif text-4xl md:text-5xl text-[#152025] mb-16 tracking-tight text-center">
          ...
          <div className="flex flex-col md:flex-row flex-wrap justify-center items-center gap-6 relative">
            ...
            <div className="hidden md:block absolute top-1/2 left-[5%] right-[5%] h-px bg-[#547808]/20 -translate-y-1/2 z-0" />
            ...
            {[
              ...
              <div key={i} className="relative z-10 flex flex-col items-center bg-[#F8F5ED] px-2 w-full md:w-auto">
                <div className="w-12 h-12 rounded-full border-2 border-[#547808] bg-[#F8F5ED] flex items-center justify-center text-[#152025] font-serif text-xl font-medium mb-3">
                  {i + 1}
                </div>
                ...
                {i < 7 && <div className="md:hidden h-8 w-px bg-[#547808]/20 my-2" />}
              </div>
            ))}
          </div>
        </motion.div>
      ...
      <section className="bg-white py-24 md:py-32 px-6">
        <motion.div 
          ...
          variants={fadeUp}
        >
          <h2 className="text-[#152025] text-3xl font-medium mb-16 tracking-tight">What the workflow covers</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-[#F8F5ED] rounded-[12px] p-8 border border-[#E8E2D2]">
                <cap.icon className="w-8 h-8 text-[#547808] mb-6" />
                <h3 className="text-[#152025] font-medium text-xl mb-3">{cap.title}</h3>
      ...
      <section className="bg-[#F1ECE0] py-24 px-6">
        <motion.div 
          ...
          variants={fadeUp}
        >
          <h2 className="font-serif text-4xl md:text-5xl text-[#152025] mb-12 tracking-tight text-center">
          ...
          <div className="grid sm:grid-cols-2 gap-x-12 gap-y-6 max-w-3xl mx-auto">
            {[
              ...
              <div key={i} className="flex items-start gap-4">
                <X className="w-6 h-6 text-[#A9F00F] shrink-0" />
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-3 max-w-3xl mx-auto">
            {[
              ...
              <span key={i} className="px-4 py-2 rounded-full border border-[#547808] text-[#F8F5ED] bg-[#111A23]">
                {outcome}
              </span>
            ))}
          </div>
      ...
      <section className="bg-white py-24 px-6 text-center">
        ...
        >
          ...
          <Link 
            href="/design-partners" 
            className="inline-flex items-center justify-center rounded-[10px] bg-[#152025] px-8 py-4 text-lg font-medium text-[#F8F5ED] hover:bg-[#111A23] transition-colors"
